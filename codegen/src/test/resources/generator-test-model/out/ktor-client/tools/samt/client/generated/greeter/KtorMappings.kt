...
fun `encode Greeting`(record: tools.samt.client.generated.greeter.Greeting): JsonElement {
...
fun `encode Person`(record: tools.samt.client.generated.greeter.Person): JsonElement {
    // Encode field id
    val `field id` = run {
        val value = record.id
        value?.let { value -> tools.samt.client.generated.greeter.`encode ID`(value) } ?: JsonNull
    }
    // Encode field name
    val `field name` = run {
...
fun `decode Person`(json: JsonElement): tools.samt.client.generated.greeter.Person {
    // Decode field id
    val `field id` = run {
        val jsonElement = json.jsonObject["id"] ?: JsonNull
        tools.samt.client.generated.greeter.`decode ID`(jsonElement)
    }
    // Decode field name
    val `field name` = run {
    ...
    return tools.samt.client.generated.greeter.Person(
        id = `field id`,
        name = `field name`,
        age = `field age`,
    )
...
fun `encode GreetingType`(value: tools.samt.client.generated.greeter.GreetingType?): JsonElement = when(value) {
    null -> JsonNull
    tools.samt.client.generated.greeter.GreetingType.HELLO -> JsonPrimitive("HELLO")
    tools.samt.client.generated.greeter.GreetingType.HI -> JsonPrimitive("HI")
    tools.samt.client.generated.greeter.GreetingType.HEY -> JsonPrimitive("HEY")
...
fun `decode GreetingType`(json: JsonElement): tools.samt.client.generated.greeter.GreetingType = when(json.jsonPrimitive.content) {
